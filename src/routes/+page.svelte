...
<div class="parallax-container">
	...
	{#each pics as pic, i}
		<img
			style="transform: translate(0,{-y / 2}px); top: {(i + 1) *
				92.5}vh; z-index = {i}; visibility: {y >
			height * 1.85 * (i + 1) - height * 0.95
				? 'visible'
				: 'hidden'}"
			src={pic}
			alt=""
...
<div class="text">
	...
	<div class="foreground">
		<div class="centered-element">
			<span class="big" style="font-size: 10vh"> Stay Frosty! </span>
